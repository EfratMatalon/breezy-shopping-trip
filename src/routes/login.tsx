...
export const Route = createFileRoute("/login")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "התחברות עם חשבון Google." },
    ],
  }),
  component: Login,
});
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="mt-6 inline-flex items-center justify-center gap-2 rounded-xl border border-border bg-card px-6 py-3 text-sm font-semibold shadow-sm transition-all hover:shadow-md active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-50"
      >
